...
-- voidlore
if (VC_COMPAT.scienceCraft) then
	table.insert(added_recipes, VOIDCRAFT.voidcraft_recipe({prefix = m_prefix, subgroup = "voidcraft-maraxsis", exalted = true}, {"hydraulic-science-pack", "maraxsis-salt", "sand"}, "vpm-a", 720, nil, {0.25, 0.45, 0.85}))
end
